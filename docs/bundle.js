...
function Demo() {
  return (0, _preact2.html)`<form onsubmit=${submit}>
        ...
        <div>
            ...
            <${PencilButton} onClick=${ev => console.log('click', ev)} />
        </div>
    </form>`;
}
